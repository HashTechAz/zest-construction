...
export function AllServices() {
  return (
    <section className="py-20 bg-white dark:bg-[#0B1525] relative overflow-hidden">
      {/* Arxa fon bəzəyi - Solğun Nöqtələr */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
          {services.map((service) => {
            ...
            return (
              <div 
                key={service.id}
                className="group relative bg-slate-50/80 dark:bg-[#11223B]/50 border border-slate-200 dark:border-white/5 p-8 rounded-2xl overflow-hidden hover:border-[#E4B040]/50 transition-all duration-300 hover:shadow-2xl hover:shadow-[#E4B040]/10 hover:-translate-y-1 backdrop-blur-sm"
              >
                {/* Arxa plandakı böyük rəqəm */}
